...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    } else if (password != document.getElementById("confirm-password").value) {
      toast.error('Password Does not match!')

      console.log(password, document.getElementById("confirm-password").value);
    } else {
      setLoading(true);
      axios
        ...
        window.location.href='/login'
            ...
            toast.error('User Alreadt Exist!')
          }
        })
        .catch((err) => {
          setLoading(false);
